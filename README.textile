...
I'm actually going to move the jni directory into an Android project, to make it easier to test and build in-place. This is mostly not a problem except that git currently doesn't like moving submodules. When I do this change you'll probably be best with a fresh checkout if possible, or otherwise moving the submodules into the correct place, updating .gitmodules and then trying to update it from there.
